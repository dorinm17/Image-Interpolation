function R = proximal_rotate(I, rotation_angle)
    ...
    % TODO: Inverseaza matricea de transformare, FOLOSIND functii predefinite!
    T_inv = inv(T);
    ...
    for y = 0 : m - 1
        for x = 0 : n - 1
            ...
            % TODO: Trece (x_p, y_p) din sistemul de coordonate [0, n - 1] în
            % sistemul de coordonate [1, n] pentru a aplica interpolarea.
            x_p = x_p + 1;
            y_p = y_p + 1;

            % TODO: Daca x_p sau y_p se afla în exteriorul imaginii,
            ...
            % TODO: Afla punctele ce înconjoara (x_p, y_p).
            x_1 = floor(x_p);
            y_1 = floor(y_p);
            x_2 = x_1 + 1;
            y_2 = y_1 + 1;
            ...
            % conform formulei.
            a = proximal_coef(I, x_1, y_1, x_2, y_2);
